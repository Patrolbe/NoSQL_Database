...
class Database:
    ...
    def _getId(self):  #generuje randomowe id
    ...
    def createUser(self, information, key):  #tworzy nowego usera
    ...
    def updateUser(self, key, user): #user jest slownikiem klucz identyfikatorem
        ...
        if data["success"] == False:
            print(MESSAGES.USER_NOT_EXISTS)
            return
        id = data["value"]["_id"]   #dodaje id do slownika z funkcji
        user["_id"] = id
    ...
    def deleteUser(self, key):
        ...
        userKeys = self._getAllUserKeys(key) #przeszukuje przestrzan nazw i zwraca klucze usera
    ...
    def createFile(self, userKey, tags, document): #tags = lista
    ...
    def deleteFileFromTag(self, userKey, tag, filename):
    ...
    def deleteFileFromAllTags(self, userKey, filename):
